	...
	<div class="center-wrapper">
		...
		<div class="center-content text-center">
			...
			<div class="error-number animated flash">
				<i class="ti-alert mr15 show"></i> <span>500</span>
			</div>

			<div class="mb25">ERREUR SERVEUR</div>

			<p>
				Un problème est survenu au niveau du serveur<br> <br>Veuillez
				réessayer plus tard ou contacter un administrateur <a
					href="mailto:mail@contact.tld">mail@contact.tld</a>
			</p>

			<!-- end layout -->
			<footer class="bg-danger clearfix mt15 pt15 pb15">
