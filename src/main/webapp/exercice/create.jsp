...
<jsp:include page="/template/header.jsp">
	...
	<jsp:param value="Solices - Détails exercice" name="titreOnglet" />
</jsp:include>

<c:url var="urlResources" value="/resources" />

<!-- Seulement une visualisation pour les clients -->
	<c:if test="${empty exercice.id}">
	...
	<c:if test="${not empty exercice.id}">
			...
			<div class="col-lg-12 col-md-12 col-xs-12">
				<div class="panel">
					...
					<div class="panel-body">
						<c:url var="createExercice" value="/exercice/create" />
						<form:form id="form" method="POST" action="${createExercice}"
							modelAttribute="exercice" role="form" class="parsley-form"
							...
							<div class="col-md-4 col-lg-4 col-md-4 col-xs-12 col-lg-offset-2">
								...
								<div class="form-group">
									<label for="calories">Muscle</label>
									<form:input type="text" class="form-control" id="muscle"
										path="muscle" placeholder="" data-parsley-required="true"
										data-parsley-trigger="change"
										data-parsley-required-message="Champ requis" />
								</div>
								<div class="pull-right">
									<a href="<c:url  value="/exercice/list" />"
