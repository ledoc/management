...
<div class="content-wrap">
	...
	<div class="wrapper">
		...
		<h2 class="text-primary">Création d'un Ouvrage</h2>
		<p class="text-muted">Le formulaire permet de créer un Ouvrage.</p>
			...
			var="createOuvrage" value="/ouvrage/create" /> <form:form id="form"
			method="POST" action="${createOuvrage}" modelAttribute="ouvrage"
			...
			<div class="panel-body">
				<div class="col-md-4">
					...
					<div class="form-group">
						...
						<div>
							<form:radiobuttons path="typeOuvrage"
								items="${typesOuvrageRadioButton}" id="typeOuvrage" itemLabel="description" onchange="javascript:activateNappeOrSurface();"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<form:input type="text" class="form-control" id="croquisDynamique"
							path="croquisDynamique" placeholder="" />
					</div>

					<div id="coteSol" class="form-group">
						<label for="coteSol">côte Sol Berge (eau de surface)</label>
						<form:input type="text" class="form-control" 
							path="coteSol" placeholder="" />
					</div>
					...
					<div id="mesureProfondeur" class="form-group">
						<label for="mesureProfondeur">Mesure repère Profondeur /NGF (nappe souterraine)</label>
						<form:input type="text" class="form-control"
							 path="mesureProfondeur" placeholder="" />
					</div>
					
					<div id="mesureRepereNGFSol" class="form-group">
						<label for="mesureRepereNGFSol">Mesure repère NGF / Sol (nappe souterraine)</label>
						<form:input type="text" class="form-control"
